...
const hora = moment.tz("Africa/Mozambique").format("HH:mm:ss")
const data = moment.tz("Africa/Mozambique").format("DD/MM/YY")
...
+ "TEL;type=CELL;type=VOICE;waid=258874524947:+258 87 4524-947\n" // WhatsApp ID + Número de telefone
